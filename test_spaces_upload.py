...
# Contenido del archivo de prueba - Incluye timestamp para que sea único
file_content = b"Este es un archivo de prueba desde un script de Python en App Platform. " + \
               f"Fecha y hora: {os.getenv('BUILD_TIME', 'N/A')} - {os.getenv('COMMIT_SHA', 'N/A')}".encode('utf-8')
file_name = "test-upload-from-script-app-platform.txt" # Nombre único para diferenciarlo
