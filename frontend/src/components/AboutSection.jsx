        ...
        <div className="flex flex-col md:flex-row items-center md:space-x-12"> 
          ...
          <div className="w-full md:w-1/2 mb-8 md:mb-0"> 
            <div className="perfect-plan-left"> 
              <div className="img-holder rounded-lg overflow-hidden shadow-xl"> 
          ...
          <div className="w-full md:w-1/2 fitness-video-area"> 
            <div className="perfect-plan-right right-text"> 
              <h2 className="text-xl md:text-xl lg:text-xl font-extrabold leading-tight mb-4 text-white">
                SOMOS LA OPCION PERFECTA PARA TU TRANSFORMACIÓN
              </h2>
              <span className="block text-lg md:text-xl font-semibold mb-4 text-chibi-green"> 
              ...
              <h4 className="text-xl md:text-xl font-bold text-white mt-6">
